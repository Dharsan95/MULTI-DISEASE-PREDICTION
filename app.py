...
if selected == "Chronic Kidney Disease Prediction":
    ...
    with col1:
        pus_cell = st.text_input('pus_cell(give 1 for normal and 0 for abnormal)')
    ...
    with col4:
        pedal_edema = st.text_input('pedal_edema(give 1 for yes and 0 for no)')

    with col1:
        anemia = st.text_input('anemia(give 1 for yes and 0 for no)')
    
    with col2:
        diabetesmellitus = st.text_input('diabetesmellitus((give 1 for yes and 0 for no))')
        
    with col3:
        hypertension = st.text_input('hypertension((give 1 for yes and 0 for no))')    
    ...
    with col3:
        packed_cell_volume = st.text_input('packed_cell_avolume')

    with col1:
        red_blood_cell_count = st.text_input('red_blood_cell_count')

    with col2:
        appetite = st.text_input('appetite((give 1 for poor and 0 for good))')
    ...
    if st.button("CKD's Test Result"):
        ...
        user_input = [pus_cell, blood_glucose_random, blood_urea,
